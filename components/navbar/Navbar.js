...
const style = {
  ...
  link__sub__wrapper: `backdrop-grayscale-md absolute flex h-[70vh] w-full flex-col items-center shadow-lg backdrop-blur-xl bg-white dark:bg-black dark:bg-opacity-20 bg-opacity-50 backdrop-filter lg:static lg:h-auto lg:flex-grow lg:flex-row lg:flex-nowrap lg:bg-transparent lg:opacity-100 lg:shadow-none lg:backdrop-filter-none `,
}
